...
export const achievements = {
  ...
  upgrades: {desc: "Reset without any upgrades.", title: "Nerfs make for good achievements", icon: "fas fa-dice", iconcolor: "red darken-2", boni: "Autoupgrades unlocked.", mult: 0.1}
};